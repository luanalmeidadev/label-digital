...
ADD COLUMN manual_discount_type text CHECK (manual_discount_type IN ('fixed', 'percent')),
ADD COLUMN manual_discount_value numeric(10,2) CHECK (manual_discount_value > 0),
ADD COLUMN manual_discount_amount numeric(10,2) CHECK (manual_discount_amount > 0),
